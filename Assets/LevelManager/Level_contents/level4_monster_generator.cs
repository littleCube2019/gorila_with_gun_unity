...
public class level4_monster_generator : monster_generator
...
{   
    ...
    IEnumerator Wave3_(){
        ...
        generateEnemy(EnemyType.BossFinal, new Vector3(7f,-3.43f,0) );
    ...
    //         Vector3 pos ;
    //         if(r > 0.5f){
    //             pos = new Vector3(UnityEngine.Random.Range(-8f, 10f),6,0);
    //         }
    //         else{
